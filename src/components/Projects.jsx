...
<>
    ...
    <div
      name="Projects"
      className="w-full h-screen  text-[#e3f6f5] "
    >
                    ...
                    <motion.div className="item group " onClick={()=>setShow(item)}>
                      <div className=" shadow-xl rounded-xl transform opacity-90   transition duration-500 hover:scale-105 hover:shadow-slate-900 hover:opacity-100">
                        ...
                        <img
                          ...
                          className="rounded-t-xl object-cover ml-[10px] mt-[10px] "
                          alt={item.id}
                        />
                        <h3 className="text-slate-200 pl-28 font-sans font-bold text-base my-4 pb-2 ">
                          {item.name}
                        </h3>
                      </div>
                    </motion.div>
